    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] dark:bg-[#020617] transition-colors duration-300">
            ...
            <main className="max-w-7xl mx-auto px-6 py-10">
                ...
                <Card className="p-5 mb-8 bg-gradient-to-r from-indigo-50 to-cyan-50 dark:from-slate-800 dark:to-slate-900 border border-indigo-100 dark:border-slate-700 rounded-3xl">
                ...
                <Card className="p-6 md:p-8 bg-white dark:bg-[#0f172a] border-none shadow-xl rounded-3xl mb-8">
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-xs font-black uppercase tracking-wider text-slate-500 mb-2">Chapter</label>
                            <select
                        ...
                        {mode === 'summary' ? (
                            <div>
                                <label className="block text-xs font-black uppercase tracking-wider text-slate-500 mb-2">Detail</label>
                                <select
                                    value={summaryDetail}
                            ...
                            <div>
                                <label className="block text-xs font-black uppercase tracking-wider text-slate-500 mb-2">Formula Count</label>
                                <input
                                    type="number"
                                    min={4}
                                    max={30}
                    ...
                    <div className="mt-5 flex flex-wrap gap-3">
                        ...
                        {mode === 'summary' ? (
                            <div className="ml-auto min-w-[260px] px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800">
                                ...
                                />
                                <p className="text-xs font-bold text-slate-500">{summaryPoints} bullet points</p>
                            </div>
                        ) : (
                            <label className="ml-auto flex items-center gap-2 text-sm font-bold text-slate-600 dark:text-slate-300">
                                <input
                                    type="checkbox"
                ...
                <Card className="p-6 md:p-8 bg-white dark:bg-[#0f172a] border-none shadow-xl rounded-3xl min-h-[420px]">
                    {content ? (
                        <>
                                ...
                                {mode === 'summary' ? (
                                    <>
                                        <section className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-900 dark:text-white">Core Ideas</h3>
                                            {renderTableSection('Core Ideas', ['Key Terms', 'Board Focus', 'Quick Recall', 'Exam Tip'])}
                                        </section>
                                        <section className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-900 dark:text-white">Key Terms</h3>
                                            {renderTableSection('Key Terms', ['Board Focus', 'Quick Recall', 'Exam Tip'])}
                                        </section>
                                        <section className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-900 dark:text-white">Board Focus</h3>
                                    ...
                                    <>
                                        <section className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-900 dark:text-white">Formulas</h3>
                                            {renderTableSection('Formulas', ['Definitions', 'Units', 'Common Mistakes', 'Exam Tip'])}
                                        </section>
                                        <section className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-900 dark:text-white">Definitions</h3>
                                            {renderTableSection('Definitions', ['Units', 'Common Mistakes', 'Exam Tip'])}
                                        </section>
                                        <section className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-900 dark:text-white">Units</h3>
                                            {renderTableSection('Units', ['Common Mistakes', 'Exam Tip'])}
                                        </section>
                                        <section className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-900 dark:text-white">Common Mistakes</h3>
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-center text-slate-500">
                            <Sparkles size={32} className="mb-3 text-[#1D9E75]" />
