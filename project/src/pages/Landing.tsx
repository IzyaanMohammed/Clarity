    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] dark:bg-[#020617] text-slate-900 dark:text-slate-100 transition-colors duration-300 font-sans overflow-x-hidden">
            ...
            <header className="sticky top-0 z-50 backdrop-blur-md bg-white/85 dark:bg-[#020617]/85 border-b border-slate-200/80 dark:border-slate-800/80 px-6 py-4 transition-all">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-black flex items-center justify-center border border-slate-800">
                            <img src="/clarity_logo.png" alt="Clarity Logo" className="w-8 h-8 object-contain" style={{ mixBlendMode: 'screen' }} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                        ...
                        <Link 
                            to="/parent-portal" 
                            className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-350 hover:bg-slate-50 dark:hover:bg-slate-900 text-sm font-black transition-colors"
                        >
                            <Users size={14} />
                            Parent Portal
                        </Link>
                        <Link to="/onboarding" className="px-5 py-2.5 bg-slate-900 dark:bg-white text-white dark:text-slate-950 text-sm font-black transition-all hover:scale-[1.02] border border-slate-800 dark:border-slate-200">
                            Get Started
                        </Link>
                    </div>
                </div>
            ...
            <main className="max-w-7xl mx-auto px-6 pt-10 pb-24 space-y-32">
                ...
                <section className="flex flex-col items-center justify-center text-center min-h-[75vh] relative overflow-hidden bg-slate-950 text-white p-8 md:p-16 border border-slate-850">
                    ...
                    {heroStage === 'intro' && (
                        <div className="relative z-10 flex flex-col items-center justify-center min-h-[220px]">
                            ...
                            <h2 className="text-4xl md:text-6xl font-mono font-bold tracking-tight text-slate-350 select-none animate-pulse">
                                {introWord}
                            </h2>
                        </div>
                    )}
                    ...
                    {heroStage !== 'intro' && (
                        <div className="relative z-10 flex flex-col items-center justify-center space-y-8 max-w-4xl min-h-[220px]">
                            {/* Staged Logo Emblem above Clarity name */}
                            <div className={`w-20 h-20 bg-black border border-slate-800 flex items-center justify-center shadow-2xl relative transition-all duration-1000 transform ${
                                heroStage !== 'reveal' ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                            }`}>
                                <div className="absolute inset-0 border border-emerald-500/10 animate-pulse pointer-events-none" />
                                <img src="/clarity_logo.png" alt="Clarity Emblem" className="w-16 h-16 object-contain" style={{ mixBlendMode: 'screen' }} />
                            </div>

                            {/* Syllabus Tag */}
                            <div className={`inline-flex items-center gap-2 px-3.5 py-1.5 bg-emerald-500/10 text-emerald-400 text-xs font-bold uppercase tracking-wider border border-emerald-500/20 transition-all duration-1000 transform ${
                                heroStage !== 'reveal' ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                            }`}>
                            ...
                            <div className="relative">
                                {/* Shockwave border effect */}
                                {heroStage === 'reveal' && (
                                    <div className="absolute inset-0 -m-8 border border-emerald-500/20 animate-ping opacity-75 pointer-events-none" />
                                )}
                            ...
                            <div className={`flex flex-wrap gap-4 justify-center pt-4 transition-all duration-1000 transform ${
                                ...
                                <Link to="/onboarding" className="px-8 py-4 bg-[#1D9E75] hover:bg-[#15805d] text-white font-black inline-flex items-center gap-2 transition-all hover:scale-[1.03] border border-[#1D9E75]">
                                    Build My Study OS
                                    <ArrowRight size={18} />
                                </Link>
                                <Link to="/parent-portal" className="px-8 py-4 border border-slate-700 bg-slate-900/50 hover:bg-slate-800 text-slate-300 font-black inline-flex items-center gap-2 transition-all hover:scale-[1.03]">
                ...
                <section className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-3 justify-center">
                            {[
                                ...
                                <button
                                    ...
                                    className={`w-full text-left p-6 border transition-all flex flex-col gap-1.5 ${
                                        activeTab === tab.id 
                        ...
                        <div className="lg:col-span-8 relative flex items-stretch">
                            ...
                            <div className="relative w-full border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-[#0f172a] shadow-2xl p-8 flex flex-col justify-between overflow-hidden">
                                {/* Window Control Bar */}
                                ...
                                <div className="flex-1 flex flex-col justify-center min-h-[300px]">
                                    {activeTab === 'workspace' && (
                                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                                            <div className="md:col-span-7 space-y-4">
                                                <div className="p-5 bg-slate-950 text-white shadow-md">
                                                    <p className="text-[10px] font-black uppercase tracking-widest text-[#1D9E75] mb-3">Today's Daily Mission</p>
                                                    <div className="space-y-2">
                                                        <div className="flex items-center justify-between text-xs p-3 bg-white/5 border border-white/10">
                                                            <span className="flex items-center gap-2"><CheckCircle2 size={14} className="text-emerald-400" /> Solve 5 Wave Optics PYQs</span>
                                                            <span className="text-[9px] uppercase font-black tracking-wider bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5">+15 XP</span>
                                                        </div>
                                                        <div className="flex items-center justify-between text-xs p-3 bg-white/5 border border-white/5">
                                                            <span className="flex items-center gap-2"><div className="w-4 h-4 border-2 border-white/20" /> Revise 2 Tricky Biology Traps</span>
                                                            <span className="text-[9px] uppercase font-black tracking-wider bg-white/10 text-white/60 px-1.5 py-0.5">Pending</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="p-4 border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 flex items-center justify-between shadow-sm">
                                                    <div>
                                                    ...
                                                    <span className="text-xs font-bold text-emerald-600 bg-emerald-50 dark:bg-emerald-950/20 px-2 py-0.5">High prep stability</span>
                                                </div>
                                            </div>
                                            <div className="md:col-span-5 flex flex-col items-center justify-center p-6 bg-slate-50 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-800">
                                    ...
                                    {activeTab === 'tutor' && (
                                        <div className="space-y-4">
                                            <div className="flex items-start gap-3">
                                                <div className="w-8 h-8 bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-xs font-black">U</div>
                                                <div className="p-4 bg-slate-100 dark:bg-slate-800 max-w-[85%]">
                                                    <p className="text-xs font-bold text-slate-855 dark:text-slate-200">Explain the Photoelectric Effect in CBSE board style.</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-3">
                                                <div className="w-8 h-8 bg-[#1D9E75] text-white flex items-center justify-center text-xs"><Brain size={14} /></div>
                                                <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 dark:bg-emerald-955/20 max-w-[85%] space-y-2">
                                                    <p className="text-xs font-bold text-slate-900 dark:text-slate-100">
                                                        It is the emission of electrons when light of threshold frequency shines on a metal surface.
                                                    </p>
                                                    <div className="p-2.5 bg-yellow-300/20 border border-yellow-300/30 text-yellow-800 dark:text-yellow-300 text-[11px] font-bold">
                                    ...
                                    {activeTab === 'simulator' && (
                                        <div className="space-y-4">
                                            <div className="p-4 bg-slate-955 text-white flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    <Trophy size={16} className="text-yellow-300" />
                                                    <span className="text-xs font-black">Physics Part I Simulator</span>
                                                </div>
                                                <span className="text-[10px] bg-white/20 px-2 py-0.5 font-mono font-black">02:14:55</span>
                                            </div>
                                            <div className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3">
                                                <p className="text-xs font-black text-slate-900 dark:text-white">Q1: State Coulomb's law. (2 Marks)</p>
                                                <div className="p-3 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/30 text-xs space-y-1.5">
                                                    <p className="font-black text-[#1D9E75] uppercase text-[9px] tracking-wider">Step-Marking Verification</p>
                                                    <p className="font-semibold text-slate-700 dark:text-slate-350 flex items-center gap-1.5"><Check size={12} className="text-emerald-500" /> State formula: F = k*q1*q2/r² (+1.0 Mark)</p>
                                                    <p className="font-semibold text-slate-700 dark:text-slate-350 flex items-center gap-1.5"><Check size={12} className="text-emerald-500" /> Define variables & vacuum permittivity (+1.0 Mark)</p>
                                    ...
                                    {activeTab === 'parent' && (
                                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                                            <div className="md:col-span-7 space-y-3">
                                                <div className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-sm">
                                                    <div>
                                                    ...
                                                    <span className="text-[10px] bg-emerald-50 dark:bg-emerald-955/20 text-[#1D9E75] px-2.5 py-1 font-black uppercase tracking-wider border border-emerald-500/20">Low Risk</span>
                                                </div>
                                                <div className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2">
                                            ...
                                            <div className="md:col-span-5 flex flex-col items-center justify-center p-6 bg-slate-50 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-800 text-center">
                ...
                <section className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div className="md:col-span-8 bg-white dark:bg-slate-900 border border-slate-205 dark:border-slate-850 p-8 shadow-sm hover:shadow-md transition-all flex flex-col md:flex-row gap-6 items-center">
                            <div className="space-y-4 flex-1">
                                <div className="w-12 h-12 bg-indigo-50 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shadow-inner">
                                    <Video size={22} />
                                </div>
                            ...
                            <div className="w-full md:w-56 p-4 bg-slate-50 dark:bg-[#0c0e14] border border-slate-105 dark:border-slate-850 space-y-2 shrink-0">
                        ...
                        <div className="md:col-span-4 bg-white dark:bg-slate-900 border border-slate-205 dark:border-slate-850 p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-6">
                            <div className="space-y-4">
                                <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-950/30 text-[#1D9E75] flex items-center justify-center shadow-inner">
                                    <Brain size={22} />
                                </div>
                            ...
                            <div className="flex items-center gap-1 bg-emerald-500/10 border border-emerald-500/20 px-3 py-2 text-emerald-700 dark:text-emerald-350 text-xs font-bold w-fit">
                        ...
                        <div className="md:col-span-4 bg-white dark:bg-slate-900 border border-slate-205 dark:border-slate-850 p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-6">
                            <div className="space-y-4">
                                <div className="w-12 h-12 bg-amber-50 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 flex items-center justify-center shadow-inner">
                                    <FileText size={22} />
                                </div>
                        ...
                        <div className="md:col-span-8 bg-white dark:bg-slate-900 border border-slate-205 dark:border-slate-850 p-8 shadow-sm hover:shadow-md transition-all flex flex-col md:flex-row gap-6 items-center">
                            <div className="space-y-4 flex-1">
                                <div className="w-12 h-12 bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-450 flex items-center justify-center shadow-inner">
                                    <BookOpen size={22} />
                                </div>
                            ...
                            <div className="p-4 bg-slate-55/50 dark:bg-[#0c0e14] border border-slate-105 dark:border-slate-850 text-xs font-bold text-[#1D9E75] flex items-center gap-2 shrink-0">
                ...
                <section className="relative overflow-hidden border border-slate-205 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 md:p-14 shadow-xl">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
                        ...
                        <div className="lg:col-span-6 space-y-6">
                            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-teal-50 dark:bg-teal-955/20 text-teal-850 dark:text-teal-450 text-xs font-black uppercase tracking-wider border border-teal-200/50">
                            ...
                            <p className="text-slate-605 dark:text-slate-400 leading-relaxed font-semibold">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start gap-3">
                                    <div className="mt-1 bg-teal-100 dark:bg-teal-955 text-teal-800 dark:text-teal-450 p-1.5"><Mail size={14} /></div>
                                    <div>
                                ...
                                <div className="flex items-start gap-3">
                                    <div className="mt-1 bg-teal-100 dark:bg-teal-955 text-teal-800 dark:text-teal-450 p-1.5"><LineChart size={14} /></div>
                                    <div>
                                ...
                                <div className="flex items-start gap-3">
                                    <div className="mt-1 bg-teal-100 dark:bg-teal-955 text-teal-800 dark:text-teal-450 p-1.5"><AlertTriangle size={14} /></div>
                                    <div>
                            ...
                            <div className="pt-2">
                                <Link 
                                    to="/parent-portal" 
                                    className="px-6 py-3.5 bg-slate-900 dark:bg-white text-white dark:text-slate-955 font-black inline-flex items-center gap-2 shadow-lg transition-all hover:scale-[1.02] border border-slate-800 dark:border-slate-200"
                                >
                        ...
                        <div className="lg:col-span-6 relative">
                            <div className="relative border border-slate-200 dark:border-slate-800 bg-slate-55/50 dark:bg-slate-950/40 p-6 shadow-md overflow-hidden">
                                <div className="flex items-center justify-between pb-4 border-b border-slate-200/60 dark:border-slate-800/60 mb-5">
                                    <div className="flex items-center gap-2">
                                        <div className="w-8 h-8 bg-slate-900 dark:bg-slate-800 text-white flex items-center justify-center font-bold text-xs border border-slate-850">
                                            P
                                        </div>
                                        <div>
                                    ...
                                    <span className="w-2.5 h-2.5 rounded-full bg-emerald-505 inline-block animate-pulse" />
                                </div>

                                <div className="space-y-4">
                                    {/* Linked Student Card */}
                                    <div className="p-3.5 bg-white dark:bg-slate-900 border border-slate-205 dark:border-slate-855 shadow-sm flex items-center justify-between">
                                        <div>
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p className="text-xs font-black text-emerald-600 bg-emerald-50 dark:bg-emerald-955/20 px-2 py-0.5 inline-block border border-emerald-500/20">Low Risk</p>
                                        </div>
                                    </div>

                                    {/* Action Plan */}
                                    <div className="p-4 bg-white dark:bg-slate-900 border border-slate-205 dark:border-slate-855 shadow-sm space-y-2.5">
                                        <p className="text-[10px] font-black uppercase text-[#1D9E75] tracking-wider">Recommended Parent Action Plan</p>
                                        <div className="space-y-2 text-xs">
                                            <div className="p-2.5 bg-slate-50 dark:bg-slate-800/40 border border-slate-105 dark:border-slate-855 flex items-start gap-2">
                ...
                <section id="pricing" className="space-y-8">
                    <div className="text-center max-w-2xl mx-auto space-y-2">
                        <span className="inline-flex items-center gap-1 px-3 py-1 bg-emerald-100 dark:bg-emerald-955/40 text-emerald-800 dark:text-emerald-450 text-xs font-black uppercase tracking-wider border border-emerald-500/25">
                        ...
                        <p className="text-slate-550 dark:text-slate-450 font-semibold leading-relaxed">
                            ...
                            <div 
                                ...
                                className={`p-8 border flex flex-col justify-between transition-all ${
                                    tier.highlight 
                                        ...
                                        : 'border-slate-205 dark:border-slate-855 bg-white dark:bg-slate-900 hover:shadow-md'
                                }`}
                            >
                                {tier.highlight && (
                                    <span className="absolute -top-3.5 left-1/2 transform -translate-x-1/2 px-3.5 py-1 bg-[#1D9E75] text-white text-[10px] font-black uppercase tracking-widest shadow-md border border-[#1D9E75]">
                                        Most Popular
                                    </span>
                                )}
                                <div className="space-y-5">
                                    <div>
                                        <span className="px-2.5 py-0.5 text-[9px] font-black uppercase tracking-wider bg-slate-100 dark:bg-slate-800 text-slate-650 dark:text-slate-300 border border-slate-205 dark:border-slate-850">
                                            {tier.badge}
                                        </span>
                                        <h3 className="text-lg font-black text-[#020617] dark:text-white mt-2.5">{tier.name}</h3>
                                    </div>
                                    <div className="flex items-baseline gap-2 pb-4 border-b border-slate-105 dark:border-slate-855">
                                    ...
                                    <ul className="space-y-2.5 text-xs font-medium text-slate-655 dark:text-slate-350">
                                        {tier.features.map((f) => (
                                ...
                                <div className="pt-6">
                                    <Link 
                                        to="/onboarding" 
                                        className={`inline-flex w-full items-center justify-center gap-2 py-3.5 text-xs font-black shadow-md transition-all border ${
                                            tier.highlight 
                ...
                <section className="max-w-3xl mx-auto space-y-6">
                    ...
                    <div className="space-y-3">
                        {faqsList.map((faq, index) => (
                            <div 
                                key={index} 
                                className="border border-slate-205 dark:border-slate-855 bg-white dark:bg-slate-900 overflow-hidden shadow-sm transition-all"
                            >
                                <button
