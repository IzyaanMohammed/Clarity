...
import { BookOpen, CheckCircle2, AlertCircle, Send, ArrowRight, Award } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f1117]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Practice Hub</h1>
          <p className="text-gray-600 dark:text-gray-400">Master every chapter with AI-graded practice sessions.</p>
        </div>
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className={`p-4 rounded-xl flex items-center justify-between ${
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-bold">Score: {gradeResult.marks_awarded} / {gradeResult.total_marks}</span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-6 bg-red-50 dark:bg-red-900/20 rounded-[24px] border border-red-100 dark:border-red-800">
                      ...
                      <p className="text-sm text-red-800 dark:text-red-300 font-medium leading-relaxed">
                        {gradeResult.feedback.split('Missing:')[1] || 'Nothing major missing! Keep it up.'}
                      </p>
                    </div>
                  </div>
                  ...
                  <Card className="p-6 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl">
                    <p className="text-xs font-bold text-slate-500 italic">
                      "Autonomous Teacher Tip: Review this concept once more before the weekend to lock it into your long-term memory."
                    </p>
                  </Card>
