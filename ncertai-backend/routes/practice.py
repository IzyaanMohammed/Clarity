...
- For mathematical answers, treat mathematically equivalent expressions (e.g. "-b/a" vs "-\frac{b}{a}" or "1/2" vs "0.5") as completely correct, regardless of whether LaTeX is used or not.
